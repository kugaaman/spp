        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h5>Pilih File Restore</h5>
                </div>
                <div class="card-body">
                    <form action="" enctype="multipart/form-data" method="post">
                        <label for="file">File Backup</label>
                        <input type="file" name="file" class="form-control" required>
                        <button type="submit" class="btn btn-danger btn-block mt-3" name="restore" onclick="return confirm('PERHATIAN !! proses restore akan mreubah total seluruh data yang ada berdasarkan file yang di pilih,sebelum restore sangat disarankan untuk melakukan proses backup terlebih dahulu,Apakah anda sudah yakin akan melajnjutkan proses ini?')"><i class="fas fa-cog"></i>Mulai Restore</button>
