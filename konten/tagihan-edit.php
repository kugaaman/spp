                ...
                <div class="card-body">
                    ...
                    <form action="aksi/tagihan.php" method="post">
                        ...
                        <input type="date" name="tanggal_jatuh_tempo" class="form-control"  <?php
                            if ($tagihan['total_terbayar'] > 0) {?> readonly <?php }
                        ...
                        <div class="alert alert-warning mt-3 text-center text bold" role="alert">
                            perhatian!! <br>
                            data tagihan yang bisa diubah hanya tagihan yang belum memiliki riwayat pembayaraan,bila ingin merubah data tersebut harap mengahpus pembayaran terlebih dahulu
                        </div>
                    <?php
                            } else {
