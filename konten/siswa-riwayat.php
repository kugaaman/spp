                    ...
                    <table id="example1" class="table table-hover table-sm">
                        ...
                        ?>
                            <tr class="<?= $warna; ?>">
                                ...
                                <td>
                                    <!-- Tombol Informasi   -->
                                    <a style="color: white" title="Informasi tagihan siswa" href="index.php?p=tagihan-info-siswa&id_tagihan=<?= $kolom['id_tagihan']; ?>"><i class="fas fa-search"></i></a>
                                    &nbsp;
                    ...
                    <table id="example1" class="table table-hover table-sm">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                <a  title="Informasi pembayaran siswa" href="index.php?p=bayar-alokasi-siswa&id_bayar=<?= $kolom['id_bayar']; ?>"><i class="fas fa-search"></i></a>
                                </td>
                                &nbsp;
