            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php?p=bayar">riwayat tagihan & pembayaran siswa</a></li>
                    ...
                    <form action="aksi/bayar.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="keterangan" class="form-control" rows="3" placeholder="Isi dengan keterangan pembayaran seperti nama bank,nama pengertian,dll" readonly><?= $bayar['keterangan']; ?></textarea>
