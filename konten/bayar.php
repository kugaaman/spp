        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($kolom['status_verifikasi'] == 'belum verifikasi') { ?>
                                        ...
                                        <a onclick="return confirm('Yakin akan mengkonfirmasi pembayaran  ini?')" href="index.php?p=bayar-konfirmasi&id_bayar=<?=  $kolom['id_bayar']; ?>" title="hapus pembayaran"><i class="fas fa-check"></i></a>

                                    <?php } ?>
                                    &nbsp;
                                    <!-- Tombol Hapus  -->
                                    <a onclick="return confirm('Yakin akan menghapus data ini?')" href="aksi/bayar.php?aksi=hapus&id_bayar=<?= $kolom['id_bayar']; ?>"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                            <!-- Modal Ubah Biaya -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="aksi/biaya.php" method="post">
                                                ...
                                                <button type="submit" class="btn btn-block bg-danger mt-3"> <i class="fas fa-save"></i> Simpan</button>
                    ...
                    <a href="index.php?p=bayar-tambah"><button type="button" class="btn bg-danger btn-block mt-3"> <i class="fas fa-plus"></i> Tambah Biaya Baru </button></a>
                </div>
            </div>
